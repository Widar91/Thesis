...
%\inputhaskell{src/iterable_functor.hs}

\haskellcode[firstline=3, lastline=50]{src/iterable_functor.hs}\\

\haskellcode[firstline=52]{src/iterable_functor.hs}\\
...
\haskellcode[firstline=3,lastline=30]{src/observable_functor.hs}\\
\haskellcode[firstline=32]{src/observable_functor.hs}\\
...
This equivalence is very important as it allows us to claim an instance of Applicative Functor and Monad for our derived type, \code{Observable}. These instances are inherited for free from the continuation monad, sparing us the tedious task of proving all the related laws.

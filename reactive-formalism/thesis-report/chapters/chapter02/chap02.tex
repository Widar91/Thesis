...
\haskellcode[lastline=19]{src/polarity.hs}\\

Before we formalize this intuition, let's convince ourselves that \code{Observable}s effectively produces a value of type \code{a} by looking at an example:\\

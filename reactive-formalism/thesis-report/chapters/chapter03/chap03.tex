...
\subsection{A note on the Reactive Contract}
\todo[inline]{does the reactive contract even make sense? for example, why do we stop on onError? there could be a version of RX which doesn't. Would that make sense? Not sure whether to include this section or not yet.}

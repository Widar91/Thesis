...
\usepackage[super,square,numbers,
...
%Minted package/ Code formatting
\usepackage{xcolor}
\usepackage{minted}
\usemintedstyle{colorful}	

\definecolor{mintedbackground}{rgb}{0.95,0.95,0.95}
\newcommand{\code}[1]{\colorbox{mintedbackground}{\texttt{#1}}}

\newcommand{\hminted}{\begin{minted}[
...
\include{chapters/chapter01/chap01}
\clearemptydoublepage

\include{chapters/chapter02/chap02}
\clearemptydoublepage

\include{chapters/chapter03/chap03}
\clearemptydoublepage

\include{chapters/chapter04/chap04}
\clearemptydoublepage
...
\include{chapters/appendices/app1B}
\clearemptydoublepage

\include{chapters/appendices/app2C}
\clearemptydoublepage
